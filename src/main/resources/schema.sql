...
(id,  nombre,                    descripcion,                                                                                                                                                                    imagenURL) values
...
(4,   'Braid',                   'Un juego de rompecabezas con toques plataformeros, donde puedes manipular el flujo del tiempo de unas maneras inusuales y extrañas.',                                          'https://m.media-amazon.com/images/M/MV5BZjZmOGFhYzktYzgxYi00NzgxLWI1ZDYtOGY5MDcyYzc4ZjlhXkEyXkFqcGdeQXVyNzUzNTQ2MjQ@._V1_FMjpg_UX1000_.jpg'),
(5,   'Borderlands 3',           '¡Vuelve el padre de los shooter-looter, con tropecientas mil armas y una aventura caótica!',                                                                                   'https://cdn1.epicgames.com/catnip/offer/BL3Wide_2560x1440-2560x1440-462318f36bee20de4412e111ef72dc62.jpg'),
...
update videojuego set ``.Videojuego.distribuidor_id = 1 where id in (1,5);
update videojuego set ``.Videojuego.distribuidor_id = 2 where id in (2);
update videojuego set ``.Videojuego.distribuidor_id = 3 where id in (3);
update videojuego set ``.Videojuego.distribuidor_id = 4 where id in (4);
update videojuego set ``.Videojuego.distribuidor_id = 5 where id in (6);
update videojuego set ``.Videojuego.distribuidor_id = 6 where id in (7);
update videojuego set ``.Videojuego.distribuidor_id = 6 where id in (8);
